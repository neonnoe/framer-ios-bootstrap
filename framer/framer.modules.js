...
},{}],"GhostLayer":[function(require,module,exports){
var GhostLayer,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;

GhostLayer = (function(superClass) {
  extend(GhostLayer, superClass);

  function GhostLayer(options) {
    var base;
    this.options = options != null ? options : {};
    if ((base = this.options).translucent == null) {
      base.translucent = false;
    }
    GhostLayer.__super__.constructor.call(this, this.options);
    this.onClick(this.fade);
    if (this.options.translucent === true) {
      this.opacity = 0.5;
    }
  }

  GhostLayer.define('translucent', {
    get: function() {
      return this.options.translucent;
    },
    set: function(value) {
      this.options.translucent = value;
      if (this.options.translucent === true) {
  ...
  GhostLayer.prototype.fade = Utils.debounce(0.5, function() {
    return Utils.delay(0.5, (function(_this) {
      return function() {
        if (_this.options.translucent === true) {
          _this.options.translucent = false;
          ...
          _this.options.translucent = true;
          return _this.animate({
            properties: {
              opacity: 0.5
            }
...
},{"./dist/appsettings.js":"dist/appsettings","./dist/menusettings.js":"dist/menusettings"}],"dist/appsettings":[function(require,module,exports){
"use strict";
...
/**
 * Must-have settings - don't delete these
 */

var APP_LANG = exports.APP_LANG = "de"; // locales have to be required in "StatusBar.coffee"
...
var APP_BACKGROUND_COLOR = exports.APP_BACKGROUND_COLOR = "444";


},{}],"dist/menusettings":[function(require,module,exports){
"use strict";
 ...
 * Animation Settings
 */
var MENU_DAMPING = exports.MENU_DAMPING = .8;
var MENU_ANIMATION_TIME = exports.MENU_ANIMATION_TIME = .6;

/**
 * Visual Settings
 */

var STATUS_BAR_HEIGHT = exports.STATUS_BAR_HEIGHT = 40;
var CHARGE_OFFSET_RIGHT = exports.CHARGE_OFFSET_RIGHT = 140;


},{}],"ios/StatusBar":[function(require,module,exports){
var StatusBar, appSettings, menuSettings, moment,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
StatusBar = (function(superClass) {
  ...
  function StatusBar(options) {
    ...
    StatusBar.__super__.constructor.call(this, options);
    moment.locale(appSettings.APP_LANG);
    this.assetLayer = Framer.Importer.load("imported/iOS Design Kit - Designing Guide@2x");
    this.assetLayer.black.visible = false;
    this.assetLayer.white.visible = false;
    this.addChild(this.assetLayer.black);
    this.addChild(this.assetLayer.white);
    this.assetLayer.chargeB.x = Screen.width - menuSettings.CHARGE_OFFSET_RIGHT;
    this.assetLayer.chargeW.x = Screen.width - menuSettings.CHARGE_OFFSET_RIGHT;
    this.states = {
      show: {
        y: 0,
        animationOptions: {
          curve: Spring({
            damping: menuSettings.MENU_DAMPING
          }),
  ...
  StatusBar.prototype.createTimer = function() {
    this.currTimer.text = moment().format('LT');
    this.currTimer.fontSize = 24;
    this.currTimer.textAlign = "center";
    return this.currTimer.center();
  };

  StatusBar.prototype.white = function(transparent) {
    if (transparent === true) {
      this.backgroundColor = "";
    } else {
      this.backgroundColor = "white";
    }
    this.currTimer.color = "black";
    this.assetLayer.black.visible = true;
    return this.assetLayer.white.visible = false;
  };

  StatusBar.prototype.black = function(transparent) {
    if (transparent === true) {
      this.backgroundColor = "";
    } else {
      this.backgroundColor = "black";
    }
    this.currTimer.color = "white";
    this.assetLayer.black.visible = false;
    return this.assetLayer.white.visible = true;
  };
  ...
  StatusBar.prototype.toggleShowHide = function() {
    return this.stateCycle("hide", "show");
  };
...
},{"../dist/appsettings.js":"dist/appsettings","../dist/menusettings.js":"dist/menusettings","moment/locale/de.js":1,"npm":"npm"}],"myModule":[function(require,module,exports){
